...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `rainbow` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `rainbow` (
  ...
  `text` varchar(20) DEFAULT NULL UNIQUE,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2017-11-11 13:24:06
